...
public class EditProductViewModel extends BaseViewModel{
    ...
    private MutableLiveData<ProductDetailResponse> details = new MutableLiveData<>();

    public MutableLiveData<ProductDetailResponse> getDetails() {
        return details;
    }
    ...
    @Inject
    public EditProductViewModel(Repository repository) {
    ...
    public void updateProduct(String id,
        ...
        compositeDisposable.add(
                repository.updateProduct(id, name, description, price,
    ...
    public void getDetail(String id){
        compositeDisposable.add(repository.getProductDetail(id)
                .doOnSubscribe(d -> loading.setValue(true))
                .doFinally(() -> loading.setValue(false))
                .subscribe(res -> details.setValue(res)
                        , throwable -> {
                            failure.setValue(throwable.getMessage());
                            Log.d(Utils.myLog, throwable.getMessage());
                        }));
    ...
    public void getCategories(){
        compositeDisposable.add(repository.getCategories()
                ...
                .subscribe(defaultResponse -> categories.setValue(defaultResponse)
                        , throwable -> {
                            failure.setValue(throwable.getMessage());
                            Log.d(Utils.myLog, "err: "+throwable.getMessage());
                        }));
    }
